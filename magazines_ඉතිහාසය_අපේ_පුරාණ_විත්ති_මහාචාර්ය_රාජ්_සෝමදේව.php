...
<head>
	...
	<title>අපේ පුරාණ විත්ති මහාචාර්ය රාජ් සෝමදේව</title>
	<meta charset="utf-8" />
...
<body class="is-preload">
	...
	<div class="container">
		<br />
		<h2>අපේ පුරාණ විත්ති මහාචාර්ය රාජ් සෝමදේව</h2>
		<div class="panel-group" id="accordion">

    <?php
    $dir = scandir("./wijaya_newspapers/ඉතිහාසය/අපේ_පුරාන_විත්ති_මහාචාර්ය_රාජ්_සෝමදේව/");
    $c=count($dir);
    sort($dir,1);
    for ($x = 0; $x < $c; $x++)
    {
      $file=$dir[$x];
        if(strcmp($file,".")!=0 and strcmp($file,"..")!=0)
        {
            ...
            echo'<audio controls preload="none">';
              echo'<source src='.'"http://rotaractmora.org/rotaractmora_static/MH/wijaya_newspapers/ඉතිහාසය/අපේ_පුරාන_විත්ති_මහාචාර්ය_රාජ්_සෝමදේව/'. $file .'"';
