    ...
    <section class="wrapper">
        <div class="inner">
            ...
            <div class="highlights" style="justify-content: center;">
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_civics.php';">
                        <header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_homescience.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>Home Science</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_agri.php'">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>Agriculture</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_english.php'">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>English</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_history.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>History</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_buddhism.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>Buddhism</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_christianity.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>Christianity</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_science.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>Science</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./past_papers_sinhala.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>Sinhala</h3>
                        </header>
