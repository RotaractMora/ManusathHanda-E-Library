...
-->
<html lang="en">
<?php echo getHeader(' | Past Papers | Tamil Medium | Ordinary Level | Tamil'); ?>
...
<body class="is-preload">
  ...
  <div class="container">
    <br />
    <h2>Select a Tamil audiobook to listen to</h2>
    ...
    <div class="panel-group" id="accordion">
      <div class="panel panel-default">
        ...
        <div id="collapse7" class="panel-collapse collapse">
          ...
          $dir = scandir("../../voice_of_humanity_2019_OL_past_papers_tamil/tamil/2019_tamil/");
          $c = count($dir);
          sort($dir, 1);
          ...
          for ($x = 0; $x < $c; $x++) {
            ...
            if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
              ...
              echo '<source src=' . '"/voice_of_humanity_2019_OL_past_papers_tamil/tamil/2019_tamil/' . $file . '"';
              ...
              echo '<a href="/download.php?file=./voice_of_humanity_2019_OL_past_papers_tamil/tamil/2019_tamil/' . $file . '"';
              echo '>';
