...
-->
<html lang="en">
<?php echo getHeader(' | Past Papers | Tamil Medium | Ordinary Level | Tamil Literature'); ?>
...
<body class="is-preload">
  ...
  <div class="container">
    <br />
    <h2>Select a Tamil Literature audiobook to listen to</h2>
    ...
    <div class="panel-group" id="accordion">
      <div class="panel panel-default">
        ...
        <div id="collapse7" class="panel-collapse collapse">
          ...
          $dir = scandir("../../voice_of_humanity_2019_OL_past_papers_tamil/tamil_lit/tamil_lit_2019/");
          $c = count($dir);
          sort($dir, 1);
          ...
          for ($x = 0; $x < $c; $x++) {
            ...
            if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
              ...
              echo '<source src=' . '"/voice_of_humanity_2019_OL_past_papers_tamil/tamil_lit/tamil_lit_2019/' . $file . '"';

              echo ' type="audio/mp3">';
              echo 'Your browser does not support the audio element.';
              echo '</audio>';
              echo '<script type="text/javascript" src="/test.js"></script>';
              echo '<a href="/download.php?file=./voice_of_humanity_2019_OL_past_papers_tamil/tamil_lit/tamil_lit_2019/' . $file . '"';
              echo '>';
