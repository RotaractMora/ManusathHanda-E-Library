...
-->
<html lang="en">
<?php echo getHeader(' | Past Papers | Tamil Medium | Ordinary Level | Health & Physical Science'); ?>
...
<body class="is-preload">
	...
	<div class="container">
		<br />
		<h2>Select a Health & Physical Science audiobook to listen to</h2>
		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-default">
				...
				<div id="collapse7" class="panel-collapse collapse">
					...
					$dir = scandir("../../voice_of_humanity_2019_OL_past_papers_tamil/health/2019_health/");
					$c = count($dir);
					sort($dir, 1);
					...
					for ($x = 0; $x < $c; $x++) {
						...
						if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
							...
							echo '<source src=' . '"/voice_of_humanity_2019_OL_past_papers_tamil/health/2019_health/' . $file . '"';
							...
							echo '<a href="/download.php?file=./voice_of_humanity_2019_OL_past_papers_tamil/health/2019_health/' . $file . '"';
							echo '>';
