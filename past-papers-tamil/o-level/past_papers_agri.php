		...
		<div class="panel-group" id="accordion">
			<div class="panel panel-default">
				...
				<div id="collapse2019" class="panel-collapse collapse">
					...
					$dir = scandir("../../voice_of_humanity_2019_OL_past_papers_tamil/Agri/Agri_2019/");
					$c = count($dir);
					sort($dir, 1);
					...
					for ($x = 0; $x < $c; $x++) {
						...
						if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
							...
							echo '<source src=' . '"/voice_of_humanity_2019_OL_past_papers_tamil/Agri/Agri_2019/' . $file . '"';
							...
							echo '<a href="/download.php?file=./voice_of_humanity_2019_OL_past_papers_tamil/Agri/Agri_2019/' . $file . '"';
							echo '>';
