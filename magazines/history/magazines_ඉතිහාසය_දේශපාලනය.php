...
-->
<html>
<?php echo getHeader(' | Magazine | History | දේශපාලනය'); ?>
...
<body class="is-preload">
  ...
  <div class="container">
    ...
    <div class="panel-group" id="accordion">
      ...
      <?php
      $dir = scandir("../../wijaya_newspapers/History/Politics/");
      $c = count($dir);
      sort($dir, 1);
      for ($x = 0; $x < $c; $x++) {
        $file = $dir[$x];
        if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
          ...
          echo '<source src=' . '"/wijaya_newspapers/History/Politics/' . $file . '"';

          echo ' type="audio/mp3">';
          echo 'Your browser does not support the audio element.';
          echo '</audio>';
          echo '<script type="text/javascript" src="/test.js"></script>';
          echo '<a href="/download.php?file=./wijaya_newspapers/History/Politics/' . $file . '"';
          echo '>';
