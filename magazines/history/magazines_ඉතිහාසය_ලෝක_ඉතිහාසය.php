...
-->
<html lang="en">
<?php echo getHeader(' | Magazine | History | ලෝක ඉතිහාසය'); ?>
...
<body class="is-preload">
  ...
  <div class="container">
    ...
    <div class="panel-group" id="accordion">
      ...
      <?php
      $dir = scandir("../../wijaya_newspapers/History/World_history/");
      $c = count($dir);
      sort($dir, 1);
      for ($x = 0; $x < $c; $x++) {
        $file = $dir[$x];
        if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
          ...
          echo '<source src=' . '"/wijaya_newspapers/History/World_history/' . $file . '"';
          ...
          echo '<a href="/download.phpp?file=./wijaya_newspapers/History/World_History/' . $file . '"';
          echo '>';
