...
-->
<html lang="en">
<?php echo getHeader(' | Magazine | Folk tales | Foreign'); ?>
...
<body class="is-preload">
	...
	<div class="container">
		<br />
		<h2>රට රට වල ජන කතා</h2>
		<div class="panel-group" id="accordion">

			<?php
			$dir = scandir("../../wijaya_newspapers/Folks/country_folks/");
			$c = count($dir);
			sort($dir, 1);
			for ($x = 0; $x < $c; $x++) {
				$file = $dir[$x];
				if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
					...
					echo '<source src=' . '"/wijaya_newspapers/Folks/country_folks/' . $file . '"';

					echo ' type="audio/mp3">';
					echo 'Your browser does not support the audio element.';
					echo '</audio>';
					echo '<script type="text/javascript" src="/test.js"></script>';
					echo '<a href="/download.php?file=./wijaya_newspapers/Folks/country_folks/' . $file . '"';
					echo '>';
