    ...
    <section class="wrapper">
        <div class="inner">
            ...
            <div class="highlights">
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./magazines_ඉතිහාසය_අපේ_පුරාණ_විත්ති_මහාචාර්ය_රාජ්_සෝමදේව.php'">
                        <header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./magazines_ඉතිහාසය_ගම.php'">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>ගම</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./magazines_ඉතිහාසය_දේශගවේෂණය.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>දේශ ගවේෂණය</h3>
                        </header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./magazines_ඉතිහාසය_දේශපාලනය.php';">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
                            <h3>දේශපාලනය</h3>
                        </header>
