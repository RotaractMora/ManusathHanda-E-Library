...
<?php
$dir = scandir("./wijaya_newspapers/Folks/Sri_lankan_folks/");
$c=count($dir);
sort($dir,1);
for ($x = 0; $x < $c; $x++)
{
  $file=$dir[$x];
    if(strcmp($file,".")!=0 and strcmp($file,"..")!=0)
    {
        ...
        echo'<audio controls preload="none">';
          echo'<source src='.'"http://rotaractmora.org/rotaractmora_static/MH/wijaya_newspapers/Folks/Sri_lankan_folks/'. $file .'"';

          echo ' type="audio/mp3">';
          echo'Your browser does not support the audio element.';
        echo'</audio>';
	echo '<script type="text/javascript" src="test.js"></script>';
        echo'<a href="download.php?file=./wijaya_newspapers/Folks/Sri_lankan_folks/'. $file .'"';
        echo'>';
