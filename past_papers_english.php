				...
				<div id="collapse4" class="panel-collapse collapse">
					...
					for ($x = 0; $x < $c; $x++) {
						...
						if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
							...
							echo '<source src=' . '"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/English/English_2016/' . $file . '"';
				...
				<div id="collapse5" class="panel-collapse collapse">
					...
					for ($x = 0; $x < $c; $x++) {
						...
						if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
							...
							echo '<audio controls preload="none">';
							echo '<source src=' . '"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/English/English_2017/' . $file . '"';
				...
				<div id="collapse6" class="panel-collapse collapse">
					...
					for ($x = 0; $x < $c; $x++) {
						...
						if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
							...
							echo '<audio controls preload="none">';
							echo '<source src=' . '"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/English/English_2018/' . $file . '"';
				...
				<div id="collapse7" class="panel-collapse collapse">
					...
					for ($x = 0; $x < $c; $x++) {
						...
						if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
							...
							echo '<audio controls preload="none">';
							echo '<source src=' . '"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/English/English_2019/' . $file . '"';
