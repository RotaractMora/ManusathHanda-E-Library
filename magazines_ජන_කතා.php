    ...
    <section class="wrapper">
        <div class="inner">
            ...
            <div class="highlights">
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./magazines_ජන_කතා_දේශීය_ජන_කතා.php'">
                        <header>
                ...
                <section>
                    <div class="content" style="cursor: pointer;" onclick="window.location='./magazines_ජන_කතා_රට_රට_වල_ජන_කතා.php'">
                        <header>
                            <img src="./images/audiobook-icon-66.png" width="50%" />
