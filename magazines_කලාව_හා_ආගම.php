...
<head>
    ...
    <link rel="stylesheet" href="./assets/css/main.css" />
            ...
            <script async src="https://www.googletagmanager.com/gtag/js?id=UA-144825636-2"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-144825636-2');
    </script>
		...
		<div class="panel-group" id="accordion">
			...
			for ($x = 0; $x < $c; $x++) {
				...
				if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
					...
					echo '<source src=' . '"http://rotaractmora.org/rotaractmora_static/MH/wijaya_newspapers/Art_and_religion/' . $file . '"';
