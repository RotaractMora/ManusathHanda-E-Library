...
-->
<html>
<?php echo getHeader(' | Spoken English course | Advanced | Conversations'); ?>
...
<body class="is-preload">
	...
	<div class="container">
		...
		<div class="panel-group" id="accordion">
			...
			<?php
			$dir = scandir("../../../andurata_athwelak/spoken_english/advanced/conversations");
			$c = count($dir);
			sort($dir, 1);
			for ($x = 0; $x < $c; $x++) {
				$file = $dir[$x];
				if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
					...
					echo '<source src=' . '"/andurata_athwelak/spoken_english/advanced/conversations/' . $file . '"';

					echo ' type="audio/mp3">';
					echo 'Your browser does not support the audio element.';
					echo '</audio>';
					echo '<script type="text/javascript" src="/test.js"></script>';
					echo '<a href="/download.php?file=./andurata_athwelak/spoken_english/advanced/conversations/' . $file . '"';
					echo '>';
