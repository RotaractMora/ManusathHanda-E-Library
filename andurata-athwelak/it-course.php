...
-->
<html>
<?php echo getHeader('RotaractMora Manusath Handa | Basic Computer Knowledge course'); ?>
...
<body class="is-preload">
	...
	<section id="audio-page-banner">
		<p>Basic Computer Knowledge course</p>
	</section>

	<!-- Main -->
	<div class="container">
		<br />
		<h2>Installing NVDA and Windows Basics</h2>
		<div class="panel-group" id="accordion">

			<?php
			$dir = scandir("../andurata_athwelak/it_course/");
			$c = count($dir);
			sort($dir, 1);
			for ($x = 0; $x < $c; $x++) {
				$file = $dir[$x];
				if (strcmp($file, ".") != 0 and strcmp($file, "..") != 0) {
					...
					echo '<source src=' . '"/andurata_athwelak/it_course/' . $file . '"';

					echo ' type="audio/mp3">';
					echo 'Your browser does not support the audio element.';
					echo '</audio>';
					echo '<script type="text/javascript" src="/test.js"></script>';
					echo '<a href="/download.php?file=./andurata_athwelak/it_course/' . $file . '"';
					echo '>';
