...
<?php
  ...
  $dir = scandir("./voice_of_humanity_2019_OL_past_papers/civics/civics_2016/");
  $c=count($dir);
  sort($dir,1);
				 ...
				 else
				 {
				 	echo substr($file,2,strlen($file)-6)."</br>";
  						...
  						echo'<audio controls preload="none">';
  							echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/civics/civics_2016/'. $file .'"';
...
<div class="panel panel-default">
  ...
  $dir = scandir("./voice_of_humanity_2019_OL_past_papers/civics/civics_2017/");
  $c=count($dir);
  sort($dir,1);
      ...
      if(strcmp($file,".")!=0 and strcmp($file,"..")!=0)
      {
         ...
         else
         {
          echo substr($file,2,strlen($file)-6)."</br>";
  						...
  						echo'<audio controls preload="none">';
  							echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/civics/civics_2017/'. $file .'"';
...
<div class="panel panel-default">
  ...
  $dir = scandir("./voice_of_humanity_2019_OL_past_papers/civics/civics_2018/");
  $c=count($dir);
  sort($dir,1);
         ...
         echo '<div class="panel-body" class="raw">';
				 ...
				 else
				 {
				 	echo substr($file,2,strlen($file)-6)."</br>";
  						...
  						echo'<audio controls preload="none">';
  							echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/civics/civics_2018/'. $file .'"';
         ...
         echo '<div class="panel-body" class="raw">';
				 ...
				 else
				 {
				 	echo substr($file,2,strlen($file)-6)."</br>";
  						...
  						echo'<audio controls preload="none">';
  							echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/civics/civics_2019/'. $file .'"';
