...
-->
<html>
<?php echo getHeader('ගමරාලගේ කතාබහා'); ?>
...
<body class="is-preload">
	...
	<div class="container">
		...
		<?php
		$dir = scandir("./wijaya_newspapers/ඉතිහාසය/ගම/ගමරාලගේ_කතාබහ/");
		$c=count($dir);
		sort($dir,1);
		for ($x = 0; $x < $c; $x++)
		{
				...
				if(strcmp($file,".")!=0 and strcmp($file,"..")!=0)
				{
					...
					echo'<div class="panel panel-default">';
						...
						echo'<audio controls preload="none">';
							echo'<source src='.'"http://rotaractmora.org/rotaractmora_static/MH/wijaya_newspapers/ඉතිහාසය/ගම/ගමරාලගේ_කතාබහ/'. $file .'"';

							echo ' type="audio/mp3">';
							echo'Your browser does not support the audio element.';
						echo'</audio>';
							echo '<script type="text/javascript" src="test.js"></script>';
						echo'<a href="download.php?file=./wijaya_newspapers/ඉතිහාසය/ගම/ගමරාලගේ_කතාබහ/'. $file .'"';
						echo'>';
