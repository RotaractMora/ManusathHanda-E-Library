         ...
         else
         {
          echo substr($file,2,strlen($file)-6)."</br>";
              ...
              echo'<audio controls preload="none">';
                echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/science/2016_science/'. $file .'"';
      ...
      if(strcmp($file,".")!=0 and strcmp($file,"..")!=0)
      {
         ...
         else
         {
          echo substr($file,2,strlen($file)-6)."</br>";
              ...
              echo'<audio controls preload="none">';
                echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/science/2017_science/'. $file .'"';
      ...
      if(strcmp($file,".")!=0 and strcmp($file,"..")!=0)
      {
         ...
         else
         {
          echo substr($file,2,strlen($file)-6)."</br>";
              ...
              echo'<audio controls preload="none">';
                echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/science/2018_science/'. $file .'"';
      ...
      if(strcmp($file,".")!=0 and strcmp($file,"..")!=0)
      {
         ...
         else
         {
          echo substr($file,2,strlen($file)-6)."</br>";
              ...
              echo'<audio controls preload="none">';
                echo'<source src='.'"http://manusathhanda.rotaractmora.org/voice_of_humanity_2019_OL_past_papers/science/2019_science/'. $file .'"';
